      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-slate-900/20 border border-dashed border-white/10 rounded-2xl">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-text-on-primary text-sm font-semibold rounded-xl hover:bg-primary/90 transition-all"
          >
